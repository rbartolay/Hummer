...
class Core_Template {
	...
	private function loadHeader() {
		if(file_exists(Configuration::getTemplatesPath() . $this->template_name . DS . $this->header_file)) {
			return Configuration::getTemplatesPath() . $this->template_name . DS . $this->header_file;
		} else {
			return Configuration::getTemplatesPath() . "default" . DS . $this->header_file;
		}
	}
	...
	private function loadFooter() {
		if(file_exists(Configuration::getTemplatesPath() . $this->template_name . DS . $this->footer_file)) {
			return Configuration::getTemplatesPath() . $this->template_name . DS . $this->footer_file;
		} else {
			return Configuration::getTemplatesPath() . "default" . DS . $this->footer_file;
		}
	}
