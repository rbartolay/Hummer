...
<div class="bottomMenu">
	<a href="/" id="bMenuItem_1" title="">Home</a>&nbsp;&nbsp;&nbsp; 
	<a href="/cm/about_us" id="bMenuItem_2" title="">About us</a>&nbsp;&nbsp;&nbsp;
	<a href="/cm/candidate/search_jobs" id="bMenuItem_3" title="">Job search</a>&nbsp;&nbsp;&nbsp; 
	<a href="/cm/clients" id="bMenuItem_4" title="">Employer area</a>&nbsp;&nbsp;&nbsp; 
	<a href="/main/sendform/4/18/3472" id="bMenuItem_5" title="">Contact us</a>&nbsp;&nbsp;&nbsp;
...
<?php global $loading_time; ?>
		<div class="powered">Copyright © Hummer.com Job Board <?php echo "2011 - " . date("Y"); ?> <br><?php echo "Page generated in " . Core_Utilities::endTimer($loading_time); ?></div>
		</div>
	</div>
</body>
</html> 